...
android {
    namespace = "de.timklge.karoomocklocation"
    compileSdk = 34

    defaultConfig {
        applicationId = "de.timklge.karoomocklocation"
        minSdk = 31
        targetSdk = 34
...
tasks.register("generateManifest") {
    ...
    doLast {
        val baseUrl = System.getenv("BASE_URL") ?: "https://github.com/timklge/karoo-karoomocklocation/releases/latest/download"
        val manifestFile = file("$projectDir/manifest.json")
        val manifest = mapOf(
            "label" to "MockLocation",
            "packageName" to "de.timklge.karoomocklocation",
            "iconUrl" to "$baseUrl/karoo-mocklocation.png",
            "latestApkUrl" to "$baseUrl/app-release.apk",
            "latestVersion" to android.defaultConfig.versionName,
            "latestVersionCode" to android.defaultConfig.versionCode,
            "developer" to "github.com/timklge",
            "description" to "Open-source extension for GPS testing",
